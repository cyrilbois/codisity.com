...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/adrianbienias/codisity.com/blob/main/",
        },
        theme: {
          customCss: require.resolve("./src/css/custom.css"),
        },
        gtag: {
          trackingID: "G-91C2T89MQL",
          anonymizeIP: true,
        },
      }),
    ],
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: "light",
        copyright: `<div class="text-base">Codisity © ${new Date().getFullYear()}, by <a href="https://adrianbienias.com" target="_blank" rel="noopener">Adrian Bienias</a></div>`,
      },
      prism: {
